...
const LocationsList = () => {
    ...
    useEffect(() => {
        const fetchLocations = async () => {
            try {
                const response = await axios.get("http://localhost:8080/atharaman");
    ...
    // Calculate the locations to display based on the current page
    ...
    // Check if there's a partial row and move the pagination if necessary
