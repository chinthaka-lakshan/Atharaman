    ...
    <div className="space-y-6">
      <div className="flex items-start space-x-6">
        ...
        <div className="flex-1">
          <h3 className="text-2xl font-bold text-gray-900 mb-2">{owner.hotel_owner_name}</h3>
          ...
          <div className="flex items-center text-sm text-gray-500">
            ...
            <span>NIC: {owner.hotel_owner_nic}</span>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-gray-900">{new Date(owner.hotel_owner_dob).toLocaleDateString()}</p>
            </div>
            <div>
              <span className="text-sm font-medium text-gray-500 flex items-start">
              ...
              <p className="text-gray-900 mt-1">{owner.hotel_owner_address}</p>
            </div>
          </div>
        </div>
      </div>
