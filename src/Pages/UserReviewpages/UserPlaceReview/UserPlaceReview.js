...
//     try {
//       const response = await axios.get(`http://localhost:8080/placereview/getPlaceReviewsByPlaceIdAndUserId/?userId=${1}&placeId=${2}`);
//       console.log(response);
      
//       if(response.data!=null){
//         console.log(response.data);
//         //console.log(locationId+"Hi")
//         console.log(user.id+"p[p[");
...
//       navigate(`/locationReview/${id}`, { state: { review, isUpdate: true } });
//     } else {
  ...
  async function loadReview(userId, placeId) {
    ...
    try {
      const response = await axios.get(
        ...
        //{ params: { userId, id } } // Pass query parameters dynamically
      );
